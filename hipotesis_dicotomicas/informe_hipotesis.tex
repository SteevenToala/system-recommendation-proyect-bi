...
\begin{enumerate}[label=\arabic*.]
  ...
  \item Graficar la l\'inea de separaci\'on $h(\mathbf{x})$ y el vector normal $\mathbf{w}$.
...
La recta $w_1 x_1 + w_2 x_2 + b = 0$ es la \textbf{l\'inea de separaci\'on}.
...
\begin{itemize}
  ...
  \item No existe l\'inea de separaci\'on expl\'icita.
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{Direcci\'on de $\mathbf{w}$:} El vector $\mathbf{w}$ apunta hacia el \textbf{cuadrante superior-izquierdo} ($x_1$ negativo, $x_2$ positivo). La clase~1 se encuentra a la izquierda y arriba de la l\'inea de separaci\'on.
...
\begin{itemize}
  ...
  \item \textbf{Direcci\'on de $\mathbf{w}$:} El vector $\mathbf{w}$ apunta hacia el \textbf{cuadrante superior-derecho} ($x_1$ positivo, $x_2$ positivo). La clase~1 se encuentra en esa direcci\'on respecto a la l\'inea de separaci\'on.
...
\begin{enumerate}
  \item El vector $\mathbf{w}$ es siempre perpendicular a la l\'inea de separaci\'on
