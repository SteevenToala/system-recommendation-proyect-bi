...
\begin{itemize}
  ...
  \item \textbf{\'Angulo:} $\theta = 135.0 grados$, indicando la direcci\'on de la clase~1.
  \item \textbf{Clase 0} (lado negativo de la recta): $X_{1}$, $X_{2}$, $X_{3}$
...
\begin{itemize}
  ...
  \item \textbf{\'Angulo:} $\theta = 333.4 grados$, indicando la direcci\'on de la clase~1.
  \item \textbf{Clase 0} (lado negativo de la recta): $X_{1}$, $X_{2}$, $X_{4}$
...
\begin{itemize}
  ...
  \item \textbf{\'Angulo:} $\theta = 45.0 grados$, indicando la direcci\'on de la clase~1.
  \item \textbf{Clase 0} (lado negativo de la recta): $X_{1}$, $X_{2}$
...
\begin{itemize}
  ...
  \item \textbf{\'Angulo:} $\theta = 326.3 grados$, indicando la direcci\'on de la clase~1.
  \item \textbf{Clase 0} (lado negativo de la recta): $X_{1}$, $X_{4}$
...
\begin{itemize}
  ...
  \item \textbf{Vector normal:} $\mathbf{w} = (0.500, 0.500)$, perpendicular a la recta.
  \item \textbf{\'Angulo:} $\theta = 45.0 grados$, indicando la direcci\'on de la clase~1.
  \item \textbf{Clase 0} (lado negativo de la recta): $X_{1}$
...
\begin{itemize}
  \item \textbf{Funci\'on separadora:} $-0.50 x_1 - 0.50 x_2 + 3.00 = 0$
  \item \textbf{Vector normal:} $\mathbf{w} = (-0.500, -0.500)$, perpendicular a la recta.
  \item \textbf{\'Angulo:} $\theta = 225.0 grados$, indicando la direcci\'on de la clase~1.
  \item \textbf{Clase 0} (lado negativo de la recta): $X_{2}$, $X_{3}$, $X_{4}$
...
\begin{itemize}
  \item \textbf{Funci\'on separadora:} $-3.00 x_1 + 2.00 x_2 + 3.00 = 0$
  \item \textbf{Vector normal:} $\mathbf{w} = (-3.000, 2.000)$, perpendicular a la recta.
  \item \textbf{\'Angulo:} $\theta = 146.3 grados$, indicando la direcci\'on de la clase~1.
  \item \textbf{Clase 0} (lado negativo de la recta): $X_{2}$, $X_{3}$
...
\begin{itemize}
  ...
  \item \textbf{Vector normal:} $\mathbf{w} = (-0.500, -0.500)$, perpendicular a la recta.
  \item \textbf{\'Angulo:} $\theta = 225.0 grados$, indicando la direcci\'on de la clase~1.
  \item \textbf{Clase 0} (lado negativo de la recta): $X_{3}$, $X_{4}$
...
\begin{itemize}
  \item \textbf{Funci\'on separadora:} $-2.00 x_1 + 1.00 x_2 + 5.00 = 0$
  \item \textbf{Vector normal:} $\mathbf{w} = (-2.000, 1.000)$, perpendicular a la recta.
  \item \textbf{\'Angulo:} $\theta = 153.4 grados$, indicando la direcci\'on de la clase~1.
  \item \textbf{Clase 0} (lado negativo de la recta): $X_{3}$
...
\begin{itemize}
  \item \textbf{Funci\'on separadora:} $1.00 x_1 - 1.00 x_2 + 1.00 = 0$
  \item \textbf{Vector normal:} $\mathbf{w} = (1.000, -1.000)$, perpendicular a la recta.
  \item \textbf{\'Angulo:} $\theta = 315.0 grados$, indicando la direcci\'on de la clase~1.
  \item \textbf{Clase 0} (lado negativo de la recta): $X_{4}$
...
\begin{itemize}
  ...
  \item \textbf{\'Angulo:} $\theta = 296.6 grados$, indicando la direcci\'on de la clase~1.
  \item \textbf{Clase 0} (lado negativo de la recta): $X_{1}$, $X_{2}$, $X_{4}$
  \item \textbf{Clase 1} (lado positivo, direcci\'on de $\mathbf{w}$): $X_{3}$
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{\'Angulo:} $\theta = 360.0 grados$, indicando la direcci\'on de la clase~1.
  \item \textbf{Clase 0} (lado negativo de la recta): $X_{1}$, $X_{2}$
  \item \textbf{Clase 1} (lado positivo, direcci\'on de $\mathbf{w}$): $X_{3}$, $X_{4}$
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{\'Angulo:} $\theta = 153.4 grados$, indicando la direcci\'on de la clase~1.
  \item \textbf{Clase 0} (lado negativo de la recta): $X_{1}$, $X_{3}$, $X_{4}$
...
\begin{itemize}
  ...
  \item \textbf{\'Angulo:} $\theta = 90.0 grados$, indicando la direcci\'on de la clase~1.
  \item \textbf{Clase 0} (lado negativo de la recta): $X_{1}$, $X_{3}$
...
\begin{itemize}
  \item \textbf{Funci\'on separadora:} $0.00 x_1 - 0.33 x_2 + 1.67 = 0$
  \item \textbf{Vector normal:} $\mathbf{w} = (0.000, -0.333)$, perpendicular a la recta.
  \item \textbf{\'Angulo:} $\theta = 270.0 grados$, indicando la direcci\'on de la clase~1.
  \item \textbf{Clase 0} (lado negativo de la recta): $X_{2}$, $X_{4}$
...
\begin{itemize}
  ...
  \item \textbf{Vector normal:} $\mathbf{w} = (0.667, -0.333)$, perpendicular a la recta.
  \item \textbf{\'Angulo:} $\theta = 333.4 grados$, indicando la direcci\'on de la clase~1.
  \item \textbf{Clase 0} (lado negativo de la recta): $X_{2}$
...
\begin{itemize}
  \item \textbf{Funci\'on separadora:} $-0.33 x_1 + 0.00 x_2 + 1.67 = 0$
  \item \textbf{Vector normal:} $\mathbf{w} = (-0.333, 0.000)$, perpendicular a la recta.
  \item \textbf{\'Angulo:} $\theta = 180.0 grados$, indicando la direcci\'on de la clase~1.
  \item \textbf{Clase 0} (lado negativo de la recta): $X_{3}$, $X_{4}$
  \item \textbf{Clase 1} (lado positivo, direcci\'on de $\mathbf{w}$): $X_{1}$, $X_{2}$
\end{itemize}
...
\begin{itemize}
  \item \textbf{Funci\'on separadora:} $-0.33 x_1 + 0.67 x_2 + 0.33 = 0$
  \item \textbf{Vector normal:} $\mathbf{w} = (-0.333, 0.667)$, perpendicular a la recta.
  \item \textbf{\'Angulo:} $\theta = 116.6 grados$, indicando la direcci\'on de la clase~1.
  \item \textbf{Clase 0} (lado negativo de la recta): $X_{3}$
  \item \textbf{Clase 1} (lado positivo, direcci\'on de $\mathbf{w}$): $X_{1}$, $X_{2}$, $X_{4}$
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{\'Angulo:} $\theta = 296.6 grados$, indicando la direcci\'on de la clase~1.
  \item \textbf{Clase 0} (lado negativo de la recta): $X_{1}$, $X_{2}$, $X_{3}$, $X_{4}$
...
\begin{itemize}
  ...
  \item \textbf{\'Angulo:} $\theta = 18.4 grados$, indicando la direcci\'on de la clase~1.
  \item \textbf{Clase 0} (lado negativo de la recta): $X_{1}$, $X_{2}$, $X_{3}$, $X_{5}$
  \item \textbf{Clase 1} (lado positivo, direcci\'on de $\mathbf{w}$): $X_{4}$
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{\'Angulo:} $\theta = 341.6 grados$, indicando la direcci\'on de la clase~1.
  \item \textbf{Clase 0} (lado negativo de la recta): $X_{1}$, $X_{2}$, $X_{3}$
...
\begin{itemize}
  ...
  \item \textbf{\'Angulo:} $\theta = 161.6 grados$, indicando la direcci\'on de la clase~1.
  \item \textbf{Clase 0} (lado negativo de la recta): $X_{1}$, $X_{2}$, $X_{4}$, $X_{5}$
  \item \textbf{Clase 1} (lado positivo, direcci\'on de $\mathbf{w}$): $X_{3}$
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{\'Angulo:} $\theta = 139.8 grados$, indicando la direcci\'on de la clase~1.
  \item \textbf{Clase 0} (lado negativo de la recta): $X_{1}$, $X_{3}$, $X_{4}$, $X_{5}$
  \item \textbf{Clase 1} (lado positivo, direcci\'on de $\mathbf{w}$): $X_{2}$
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{\'Angulo:} $\theta = 56.3 grados$, indicando la direcci\'on de la clase~1.
  \item \textbf{Clase 0} (lado negativo de la recta): $X_{1}$, $X_{3}$, $X_{5}$
  \item \textbf{Clase 1} (lado positivo, direcci\'on de $\mathbf{w}$): $X_{2}$, $X_{4}$
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{\'Angulo:} $\theta = 135.0 grados$, indicando la direcci\'on de la clase~1.
  \item \textbf{Clase 0} (lado negativo de la recta): $X_{1}$, $X_{4}$, $X_{5}$
  \item \textbf{Clase 1} (lado positivo, direcci\'on de $\mathbf{w}$): $X_{2}$, $X_{3}$
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{\'Angulo:} $\theta = 101.3 grados$, indicando la direcci\'on de la clase~1.
  \item \textbf{Clase 0} (lado negativo de la recta): $X_{1}$, $X_{5}$
  \item \textbf{Clase 1} (lado positivo, direcci\'on de $\mathbf{w}$): $X_{2}$, $X_{3}$, $X_{4}$
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{\'Angulo:} $\theta = 36.9 grados$, indicando la direcci\'on de la clase~1.
  \item \textbf{Clase 0} (lado negativo de la recta): $X_{1}$
...
\begin{itemize}
  \item \textbf{Funci\'on separadora:} $-0.50 x_1 - 0.37 x_2 + 3.25 = 0$
  \item \textbf{Vector normal:} $\mathbf{w} = (-0.500, -0.375)$, perpendicular a la recta.
  \item \textbf{\'Angulo:} $\theta = 216.9 grados$, indicando la direcci\'on de la clase~1.
  \item \textbf{Clase 0} (lado negativo de la recta): $X_{2}$, $X_{3}$, $X_{4}$, $X_{5}$
  \item \textbf{Clase 1} (lado positivo, direcci\'on de $\mathbf{w}$): $X_{1}$
\end{itemize}
...
\begin{itemize}
  \item \textbf{Funci\'on separadora:} $0.13 x_1 - 0.67 x_2 + 1.93 = 0$
  \item \textbf{Vector normal:} $\mathbf{w} = (0.133, -0.667)$, perpendicular a la recta.
  \item \textbf{\'Angulo:} $\theta = 281.3 grados$, indicando la direcci\'on de la clase~1.
  \item \textbf{Clase 0} (lado negativo de la recta): $X_{2}$, $X_{3}$, $X_{4}$
...
\begin{itemize}
  \item \textbf{Funci\'on separadora:} $-1.20 x_1 - 0.40 x_2 + 8.20 = 0$
  \item \textbf{Vector normal:} $\mathbf{w} = (-1.200, -0.400)$, perpendicular a la recta.
  \item \textbf{\'Angulo:} $\theta = 198.4 grados$, indicando la direcci\'on de la clase~1.
  \item \textbf{Clase 0} (lado negativo de la recta): $X_{2}$, $X_{4}$, $X_{5}$
  \item \textbf{Clase 1} (lado positivo, direcci\'on de $\mathbf{w}$): $X_{1}$, $X_{3}$
\end{itemize}
...
\begin{itemize}
  \item \textbf{Funci\'on separadora:} $-0.50 x_1 - 0.75 x_2 + 7.50 = 0$
  \item \textbf{Vector normal:} $\mathbf{w} = (-0.500, -0.750)$, perpendicular a la recta.
  \item \textbf{\'Angulo:} $\theta = 236.3 grados$, indicando la direcci\'on de la clase~1.
  \item \textbf{Clase 0} (lado negativo de la recta): $X_{2}$, $X_{4}$
...
\begin{itemize}
  \item \textbf{Funci\'on separadora:} $2.89 x_1 - 2.44 x_2 + 4.11 = 0$
  \item \textbf{Vector normal:} $\mathbf{w} = (2.889, -2.444)$, perpendicular a la recta.
  \item \textbf{\'Angulo:} $\theta = 319.8 grados$, indicando la direcci\'on de la clase~1.
  \item \textbf{Clase 0} (lado negativo de la recta): $X_{2}$
...
\begin{itemize}
  ...
  \item \textbf{Vector normal:} $\mathbf{w} = (-0.545, 0.182)$, perpendicular a la recta.
  \item \textbf{\'Angulo:} $\theta = 161.6 grados$, indicando la direcci\'on de la clase~1.
  \item \textbf{Clase 0} (lado negativo de la recta): $X_{4}$, $X_{5}$
  \item \textbf{Clase 1} (lado positivo, direcci\'on de $\mathbf{w}$): $X_{1}$, $X_{2}$, $X_{3}$
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{Vector normal:} $\mathbf{w} = (-0.500, 1.000)$, perpendicular a la recta.
  \item \textbf{\'Angulo:} $\theta = 116.6 grados$, indicando la direcci\'on de la clase~1.
  \item \textbf{Clase 0} (lado negativo de la recta): $X_{5}$
